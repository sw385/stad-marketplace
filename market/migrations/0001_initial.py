# Generated by Django 2.2.1 on 2019-09-21 21:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Category',
            fields=[
                ('name', models.CharField(help_text='Enter a name for this category.', max_length=30, primary_key=True, serialize=False)),
            ],
            options={
